class Listing < Sequel::Model
  ...
  # The ++validate++ method verifies that a listing has a ++:title++ and a
  # ++:season_id++, returning a ++Sequel::ValidationError++ if these 
  # conditions aren't met. This method extends the ++validate++ method
  # that is added to the ++Sequel::Model++ instance by the ++:validation_helpers++
  # plugin.
